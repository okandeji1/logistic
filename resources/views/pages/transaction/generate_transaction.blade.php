                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <form action="/generate-transaction" method="post">
                            ...
                            <div class="card">
                                        ...
                                        <div class="row">
                                            @if ($order->customer)
                                                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                                    ...
                                                    <input type="text" value="{{ $order->customer->uuid }}"
                                                        class="form-control">
                                                </div>
                                            @elseif($order->user)
                                                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                                    <label>Customer ID</label>
                                                    <input type="text" value="{{ $order->user->uuid }}"
                                                        class="form-control">
                                                </div>
                                            @else
                                                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" value="Customer doesn't exist" class="form-control"
                                                        disabled>
                                                </div>
                                            @endif
                                            <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                ...
                                @else
                                    <h3>You can no longer view this order</h3>
                                @endif
                            </div>
                        </form>
                    </div>
