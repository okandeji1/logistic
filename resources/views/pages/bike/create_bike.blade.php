        ...
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                    <h4 class="page-title m-b-0">Register Bike</h4>
                </li>
                <!--  -->
            </ul>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="/create-bike" id="wizard_with_validation"
                                        ...
                                        <div class="row">
                                            <div class="form-group form-float col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-line">
                                                    ...
                                                    <input type="text" class="form-control :class=" { 'is-invalid' :
                                                        form.errors.has('name') }" name="name" id="name" required>
                                            ...
                                            <div class="form-group form-float col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-line">
                                                    ...
                                                    <input type="date" class="form-control :class=" { 'is-invalid' :
                                                        form.errors.has('dateOfPurchase') }" name="dateOfPurchase"
                                            ...
                                            <div class="form-group form-float col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-line">
                                                    ...
                                                    <input type="text" class="form-control :class=" { 'is-invalid' :
                                                        form.errors.has('placeOfPurchase') }" name="placeOfPurchase"
                                                        id="placeOfPurchase" required>
                                            ...
                                            <div class="form-group form-float col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-line">
                                                    ...
                                                    <input type="text" class="form-control :class=" { 'is-invalid' :
                                                        form.errors.has('cost') }" name="cost" id="cost" required>
                                            ...
                                            <div class="form-group form-float col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-line">
                                                    ...
                                                    <input type="text" class="form-control :class=" { 'is-invalid' :
                                                        ...
                                                        id="plateNumber" required>
                                                    <has-error :form="form" field="plateNumber"></has-error>
                                                </div>
                                            </div>
                                            <div class="form-group form-float col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-line">
                                                    <label class="form-label">Accessory Bought</label>
                                                    <input type="text" class="form-control :class=" { 'is-invalid' :
                                                        form.errors.has('accessoryBought') }" name="accessoryBought"
                                                        id="accessoryBought" required>
                                                    <has-error :form="form" field="accessoryBought"></has-error>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-line">
                                                    ...
                                                    @if (count($riders) > 0)
                                                        <select class="form-control :class=" { 'is-invalid' :
                                                            form.errors.has('riderEmail') }" name="riderEmail" required>
                                                            @foreach ($riders as $rider)
                                                                <option value="{{ $rider->email }}">{{ $rider->fullname }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="row ark d-none">
                                                <div class="form-group form-float col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="form-line">
                                                        ...
                                                        <input type="date" class="form-control :class=" { 'is-invalid' :
                                                            form.errors.has('arkRegDate') }" name="arkRegDate"
                                                            id="arkRegDate">
