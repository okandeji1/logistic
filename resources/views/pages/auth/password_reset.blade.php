              ...
              <div class="card-body">
                ...
                <form method="POST" action="/auth-password-reset/{{$user->id}}">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control" name="Oldpassword" tabindex="1" autofocus>
                  </div>
                  <div class="form-group">
                    <label for="password">New Password</label>
                    <input id="password" type="password" class="form-control pwstrength :class=" { 'is-invalid' :
                      form.errors.has('password') }" data-indicator="pwindicator" name="password" tabindex="2" required>
                  ...
                  <div class="form-group">
                    ...
                    <input id="password-confirm" type="password" class="form-control :class=" { 'is-invalid' :
