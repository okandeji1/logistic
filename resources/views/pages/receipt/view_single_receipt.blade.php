  ...
  <section class="section">
    <ul class="breadcrumb breadcrumb-style ">
      <li class="breadcrumb-item">
        <h4 class="page-title m-b-0">Receipt</h4>
      </li>
    </ul>
        ...
        <div class="col-12 col-md-12 col-lg-12">
          <div class="card">
            <div class="card-header">
              <a href="/generate-mail/{{$transaction->reference}}" class="btn btn-success mr-1" type="submit">Mail
                Receipt</a>
              <button class="btn btn-info mr-1" type="reset">Receipt Details</button>
