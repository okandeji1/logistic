        ...
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                    <h4 class="page-title m-b-0">Rider Accidents</h4>
                </li>
                        ...
                        <div class="card">
                            <div class="card-header">
                                {{-- <button class="btn btn-success" type="reset"
                                    data-toggle="modal" data-target="#updateBikeMaintenance"><i
                                        class="fa fa-plus text-white m-3">Update Bike
                                        accident</i></button> --}}
                            </div>
                            ...
                            @else
                                <h3>No accidents recorded for this rider</h3>
                            @endif
                        </div>
                    </div>
                </div>
    ...
    {{-- <div class="modal fade" id="updateBikeMaintenance" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/update-bike-accident" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-float col-12">
                        <div class=" form-line">
                            <label class="form-label">Claim from insurance<span class="text-danger">*</span></label>
                            <textarea name="insuranceClaim" id="" cols="30" rows="10" class="form-control :class="
                                { 'is-invalid' : form.errors.has('insuranceClaim') }" required></textarea>
                            <has-error :form="form" field="insuranceClaim"></has-error>
                        </div>

                    </div>
                    <input type="hidden" name="rider" value="{{ $accident->rider->id }}">
                    <div class="form-group form-float col-12">
                        <div class="form-line">
