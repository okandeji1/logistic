        ...
        <section class="section">
            <ul class="breadcrumb breadcrumb-style ">
                <li class="breadcrumb-item">
                    <h4 class="page-title m-b-0">Create Customer</h4>
                </li>
                <!--  -->
            </ul>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="/create-customer" id="wizard_with_validation">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <input type="email" class="form-control :class=" { 'is-invalid' :
                                                    form.errors.has('email') }" name="email" id="email">
